import type { PluginContext } from "@base-harness/plugin/v2/effect"
...
import type { IntegrationEnvMethod, IntegrationKeyMethod, IntegrationOAuthMethod } from "@base-harness/sdk/v2/types"
