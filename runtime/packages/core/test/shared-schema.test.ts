...
import { Agent } from "@base-harness/schema/agent"
import { Location } from "@base-harness/schema/location"
import { Model } from "@base-harness/schema/model"
import { AgentAttachment, FileAttachment, Prompt, Source } from "@base-harness/schema/prompt"
import { Provider } from "@base-harness/schema/provider"
import { Project } from "@base-harness/schema/project"
import { ProjectDirectories } from "@base-harness/schema/project-directories"
import { PermissionV1 } from "@base-harness/schema/permission-v1"
import { Session } from "@base-harness/schema/session"
import { SessionInput } from "@base-harness/schema/session-input"
import { SessionMessage } from "@base-harness/schema/session-message"
import { Workspace } from "@base-harness/schema/workspace"
import { Command } from "@base-harness/schema/command"
import { Connection } from "@base-harness/schema/connection"
import { Credential } from "@base-harness/schema/credential"
import { FileSystem } from "@base-harness/schema/filesystem"
import { Integration } from "@base-harness/schema/integration"
import { LLM } from "@base-harness/schema/llm"
import { Permission } from "@base-harness/schema/permission"
import { Plugin } from "@base-harness/schema/plugin"
import { Pty } from "@base-harness/schema/pty"
import { Reference } from "@base-harness/schema/reference"
import { SessionTodo } from "@base-harness/schema/session-todo"
import { Skill } from "@base-harness/schema/skill"
import { AbsolutePath, DateTimeUtcFromMillis, optional, statics } from "@base-harness/schema/schema"
...
test("Core reuses the canonical shared schemas", async () => {
  const [
    ...
    import("@base-harness/core/command"),
    import("@base-harness/core/integration/connection"),
    import("@base-harness/core/credential"),
    import("@base-harness/core/filesystem"),
    import("@base-harness/core/integration"),
    import("@base-harness/core/location"),
    import("@base-harness/llm"),
    import("@base-harness/core/permission"),
    import("@base-harness/core/v1/permission"),
    import("@base-harness/core/project/copy"),
    import("@base-harness/core/pty"),
    import("@base-harness/core/project/schema"),
    import("@base-harness/core/reference"),
    import("@base-harness/core/session/input"),
    import("@base-harness/core/session/message"),
    import("@base-harness/core/session/todo"),
    import("@base-harness/core/session/prompt"),
    import("@base-harness/core/skill"),
    import("@base-harness/core/v2-schema"),
    import("@base-harness/core/schema"),
    import("@base-harness/core/workspace"),
  ])
