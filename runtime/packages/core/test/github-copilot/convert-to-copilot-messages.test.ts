import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@base-harness/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
