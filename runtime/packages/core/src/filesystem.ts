...
import { Entry, FileSystem, FindInput, Match } from "@base-harness/schema/filesystem"
export { Entry, Match, Submatch } from "@base-harness/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/FileSystem") {}
