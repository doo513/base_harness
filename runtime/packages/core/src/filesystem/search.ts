...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.BASE_HARNESS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
