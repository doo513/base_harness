...
import { FileSystemWatcher } from "@base-harness/schema/filesystem-watcher"
...
declare const BASE_HARNESS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof BASE_HARNESS_LIBC === "undefined" ? undefined : BASE_HARNESS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.BASE_HARNESS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.BASE_HARNESS_EXPERIMENTAL_FILEWATCHER)) {
