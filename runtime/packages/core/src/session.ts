...
import { ListAnchor } from "@base-harness/schema/session"
...
import { SessionDurable } from "@base-harness/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/Session") {}
