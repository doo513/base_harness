...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@base-harness/llm"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/ToolRegistry") {}
