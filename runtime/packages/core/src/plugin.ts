...
import type { Plugin as PluginRuntime } from "@base-harness/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/Plugin") {}
