...
export { Effect, Rule, Ruleset } from "@base-harness/schema/permission"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/Permission") {}
