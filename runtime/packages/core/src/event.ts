...
import type { Data, Definition, Payload } from "@base-harness/schema/event"
...
import { Durable } from "@base-harness/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@base-harness/schema/event").ID
export type { Data, Definition, Payload } from "@base-harness/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Event") {}
