...
export const Info = Schema.Struct({
  ...
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommandV1.Info)).annotate({
    description: "Command configuration, see https://base-harness.local/docs/commands",
  }),
  ...
  ).annotate({ description: "Agent configuration, see https://base-harness.local/docs/agents" }),
