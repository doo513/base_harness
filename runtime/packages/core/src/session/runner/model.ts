...
import { type Model } from "@base-harness/llm"
import * as AnthropicMessages from "@base-harness/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@base-harness/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@base-harness/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@base-harness/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/v2/SessionRunnerModel") {}
