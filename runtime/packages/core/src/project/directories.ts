...
import type { EffectDrizzleSqlite } from "@base-harness/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/ProjectDirectories") {}
