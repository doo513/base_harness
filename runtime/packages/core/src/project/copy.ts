...
import { Event } from "@base-harness/schema/project-directories"
import { ProjectCopy } from "@base-harness/schema/project-copy"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/ProjectCopy") {}
