...
- Effect plugins import `@base-harness/plugin/v2/effect`, not `@base-harness/core`.
- Public domain values use generated `@base-harness/sdk` types.
...
- Define `PluginHost` domain capabilities in `@base-harness/plugin/v2/effect`.
