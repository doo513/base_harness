...
describe("opencode read-only commands (smoke)", () => {
  ...
  // BASE_HARNESS_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh BASE_HARNESS_TEST_HOME means
  ...
  // in production it'd be a path under BASE_HARNESS_TEST_HOME / XDG_DATA_HOME.
