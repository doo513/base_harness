...
//   - BASE_HARNESS_CONFIG_CONTENT      : provider config inline, no files to find
//   - BASE_HARNESS_TEST_HOME           : pins os.homedir() → tmpdir
//   - BASE_HARNESS_DISABLE_PROJECT_CONFIG : skip walking up for base-harness.jsonc
//   - BASE_HARNESS_PURE                : skip external plugin discovery + install
//   - BASE_HARNESS_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
import { AppProcess } from "@base-harness/core/process"
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    ...
    BASE_HARNESS_CONFIG_CONTENT: configJson,
    BASE_HARNESS_DISABLE_PROJECT_CONFIG: "1",
    BASE_HARNESS_PURE: "1",
    BASE_HARNESS_DISABLE_AUTOUPDATE: "1",
    BASE_HARNESS_DISABLE_AUTOCOMPACT: "1",
    BASE_HARNESS_DISABLE_MODELS_FETCH: "1",
    BASE_HARNESS_AUTH_CONTENT: "{}",
  }
}
  ...
  return Effect.gen(function* () {
    ...
    const runOpts = (opts?: RunOpts): SpawnOpts | undefined => {
      ...
      return {
        ...
        env: {
          ...opts.env,
          BASE_HARNESS_CONFIG_CONTENT: JSON.stringify({
