...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders BASE_HARNESS_CALLER", () => {
    process.env["BASE_HARNESS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode BASE_HARNESS_CALLER", () => {
    process.env["BASE_HARNESS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown BASE_HARNESS_CALLER", () => {
    process.env["BASE_HARNESS_CALLER"] = "unknown"
