 ...
 *   "@base-harness/ServerAuthConfig",
 *   {
 *     password: Config.string("BASE_HARNESS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("BASE_HARNESS_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
