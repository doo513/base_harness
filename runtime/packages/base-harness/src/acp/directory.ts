...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@base-harness/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@base-harness/ACPDirectory") {}
