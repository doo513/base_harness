...
import { EventSequenceTable, EventTable } from "@base-harness/core/event/sql"
import { FSUtil } from "@base-harness/core/fs-util"
import { RuntimeFlags } from "@/effect/runtime-flags"
import { ProjectV2 } from "@base-harness/core/project"
import { Slug } from "@base-harness/core/util/slug"
...
import { WorkspaceEvent } from "@base-harness/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        BASE_HARNESS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        BASE_HARNESS_WORKSPACE_ID: config.id,
        BASE_HARNESS_EXPERIMENTAL_WORKSPACES: "true",
