...
import { buildPrompt } from "@base-harness/core/session/compaction"
import { SessionCompactionEvent } from "@base-harness/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/SessionCompaction") {}
