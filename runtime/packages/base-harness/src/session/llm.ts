...
import { llmClient } from "@base-harness/core/effect/app-node-platform"
...
import type { LLMEvent } from "@base-harness/llm"
import { LLMClient } from "@base-harness/llm/route"
import type { LLMClientService } from "@base-harness/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @base-harness/llm. It
