...
import { SessionStatusEvent } from "@base-harness/schema/session-status-event"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/SessionStatus") {}
