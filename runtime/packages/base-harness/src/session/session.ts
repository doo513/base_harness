...
import type { ProviderMetadata, Usage } from "@base-harness/llm"
...
import { PartTable, SessionTable } from "@base-harness/core/session/sql"
...
import { NonNegativeInt, optional } from "@base-harness/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".base-harness", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Session") {}
