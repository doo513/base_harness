import type { JsonSchema, LLMRequest, ProviderMetadata } from "@base-harness/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@base-harness/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @base-harness/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
