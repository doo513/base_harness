import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@base-harness/llm"
...
// Move this extraction into @base-harness/llm when Copilot is handled by the native runtime.
