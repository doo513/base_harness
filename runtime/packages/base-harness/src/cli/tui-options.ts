...
// Keep the default command's builder synchronous: yargs root help does not
// await an asynchronous default builder before completing its parse callback.
export const TuiCommandBuilder = (yargs: Argv) =>
