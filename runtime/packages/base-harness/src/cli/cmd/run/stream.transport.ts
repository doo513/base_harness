...
import type { Event, GlobalEvent, OpencodeClient } from "@base-harness/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@base-harness/RunStreamTransport") {}
