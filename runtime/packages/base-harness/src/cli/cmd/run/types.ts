// Shared type vocabulary for the direct interactive mode (`base-harness --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@base-harness/sdk/v2"
