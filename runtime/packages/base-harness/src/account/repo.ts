...
import { AccountStateTable, AccountTable } from "@base-harness/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/AccountRepo") {}
