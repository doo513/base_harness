import type { Hooks, PluginInput } from "@base-harness/plugin"
import type { Model } from "@base-harness/sdk/v2"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Base Harness will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
