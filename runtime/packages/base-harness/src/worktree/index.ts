...
import { path } from "@base-harness/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@base-harness/core/project"
...
import { WorktreeEvent } from "@base-harness/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `base-harness/${name}`
