...
import type * as SDK from "@base-harness/sdk/v2"
...
import { SessionShareTable } from "@base-harness/core/share/sql"
...
const disabled = process.env["BASE_HARNESS_DISABLE_SHARE"] === "true" || process.env["BASE_HARNESS_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/ShareNext") {}
