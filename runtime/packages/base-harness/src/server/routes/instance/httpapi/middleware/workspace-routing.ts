...
>()("@base-harness/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@base-harness/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.BASE_HARNESS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.BASE_HARNESS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-base-harness-directory"] || process.cwd()
}
