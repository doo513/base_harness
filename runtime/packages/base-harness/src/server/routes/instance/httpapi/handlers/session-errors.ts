...
const controlRejections = {
  ...
  DOMAIN_UNKNOWN: "The requested domain is not registered with this Host.",
  OVERLAY_UNKNOWN: "The requested overlay is not registered with this Host.",
  DOMAIN_CONTROL_INVALID: "The domain or overlay control is invalid.",
  DOMAIN_SKILL_INCOMPATIBLE: "The requested overlay is incompatible with the selected domain.",
  DOMAIN_SKILL_CONFLICT: "The requested overlays have conflicting policies.",
  ...
  PLAN_RUN_CHANGED: "The planning run changed or was cancelled. Review the current plan before execution.",
  PLAN_DOMAIN_BINDING_REQUIRED: "This saved plan needs a fresh review before execution. Revise or discard it to rebuild its domain binding.",
  PLAN_DOMAIN_BINDING_CHANGED: "The domain or execution strategies changed. Revise or discard the plan and review it again before execution.",
  PLAN_EXECUTION_GRAPH_CHANGED: "Execution would change the reviewed plan. Revise or discard it and review the new instructions before execution.",
