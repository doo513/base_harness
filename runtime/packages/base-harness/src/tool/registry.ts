...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@base-harness/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/ToolRegistry") {}
