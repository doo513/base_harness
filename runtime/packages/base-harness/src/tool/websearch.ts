...
import { checksum } from "@base-harness/core/util/encode"
...
export function selectWebSearchProvider(sessionID: string, flags = { exa: false, parallel: false }): WebSearchProvider {
  const override = process.env.BASE_HARNESS_WEBSEARCH_PROVIDER
...
function parallelAuthHeaders() {
  const headers = { "User-Agent": `base-harness/${InstallationVersion}` }
