...
import { ProjectDirectoryTable, ProjectTable } from "@base-harness/core/project/sql"
import { ProjectDirectories } from "@base-harness/core/project/directories"
...
import { which } from "@base-harness/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.BASE_HARNESS_FAKE_VCS)
