...
import { AbsolutePath, type DeepMutable } from "@base-harness/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@base-harness/Agent") {}
      ...
      Effect.fn("Agent.state")(function* (ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          explore: {
            ...
            description: `Read-only agent specialized for exploring codebases. Call it with a structured exploration request using quick, standard, or deep thoroughness. It can only list, glob, grep, and read workspace content.`,
