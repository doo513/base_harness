...
import baseHarnessThemeJson from "./themes/base-harness.json"
...
export const baseHarnessTheme = baseHarnessThemeJson as DesktopTheme
/** @deprecated Use baseHarnessTheme. */
export const opencodeTheme = baseHarnessTheme
