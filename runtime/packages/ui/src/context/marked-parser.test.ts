...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[Base Harness](https://base-harness.local)")).toBe(
    '<p><a href="https://base-harness.local" class="external-link" target="_blank" rel="noopener noreferrer">Base Harness</a></p>\n',
  )
})
