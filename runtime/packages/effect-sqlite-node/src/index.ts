...
export const TypeId: TypeId = "~@base-harness/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@base-harness/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@base-harness/effect-sqlite-node/NodeSqliteClient")
