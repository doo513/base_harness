...
> current private `@base-harness/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@base-harness/ai`
...
- Secondary audience: Base Harness and other durable agent runtimes
...
import { LLM } from "@base-harness/ai"
import { OpenAI } from "@base-harness/ai/providers/openai"
...
```ts
import { Message } from "@base-harness/ai"
...
import { LLM, Tool } from "@base-harness/ai"
...
Base Harness and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@base-harness/ai/promise"
import { OpenAI } from "@base-harness/ai/providers/openai"
...
```ts
import { LLMSchema } from "@base-harness/ai/schema"
...
```ts
import { Provider, Protocol } from "@base-harness/ai/provider"
...
@base-harness/ai/promise
  Promise/AsyncIterable LLM facade

@base-harness/ai/schema
  serializable domain schemas

@base-harness/ai/provider
  experimental Provider and Protocol authoring APIs

@base-harness/ai/providers/openai
@base-harness/ai/providers/anthropic
@base-harness/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@base-harness/llm`                      | `@base-harness/ai`                                           |
...
Base Harness should migrate to `generateTurn` / `streamTurn`, preserving its durable
