...
import defaultSoundPath from "@base-harness/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@base-harness/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@base-harness/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@base-harness/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@base-harness/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@base-harness/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "base-harness"
const DEFAULT_PACK_ID = "base-harness.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Base Harness Default",
  builtin: true,
  sounds: {
