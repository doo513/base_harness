...
import type { TuiPlugin, TuiPluginApi, TuiRouteCurrent } from "@base-harness/plugin/tui"
import type { SnapshotFileDiff, VcsFileDiff } from "@base-harness/sdk/v2"
import {
  TextAttributes,
  type BorderSides,
  type BoxRenderable,
...
const PLAIN_TEXT_FILETYPE = "base-harness-plain-text"
