...
import type { PermissionRequest } from "@base-harness/sdk/v2"
...
import { BASE_HARNESS_BASE_MODE, useBindings, useCommandShortcut } from "../../keymap"
          ...
          body={
            <Switch>
              <Match when={props.request.always.length === 1 && props.request.always[0] === "*"}>
                <TextBody title={"This will allow " + props.request.permission + " until Base Harness is restarted."} />
              </Match>
              <Match when={true}>
