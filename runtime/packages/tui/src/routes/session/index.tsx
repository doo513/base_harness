...
import { BASE_HARNESS_BASE_MODE, useBindings, useCommandShortcut, useOpencodeKeymap } from "../../keymap"
...
<span style={{ fg: theme.text }}>{harnessActorLabel(props.message.mode)}</span>
