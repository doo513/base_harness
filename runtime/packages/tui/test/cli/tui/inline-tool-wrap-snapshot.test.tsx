...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/base-harness/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/base-harness (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/base-harness/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/base-harness/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const BASE_HARNESS_DB|BASE_HARNESS_DB|BASE_HARNESS_DEV|Global\\.Path\\.data|data =" in packages/base-harness/src (115 matches)',
  },
] as const
