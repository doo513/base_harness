...
describe("translate app", () => {
  ...
  test("maps product locale codes to their glossaries", () => {
    expect(glossaryFile("fr")).toBe(".base-harness/glossary/fr.md")
    expect(glossaryFile("zh")).toBe(".base-harness/glossary/zh-cn.md")
    expect(glossaryFile("zht")).toBe(".base-harness/glossary/zh-tw.md")
  })
